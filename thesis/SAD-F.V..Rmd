...
I valori risultano molto altalenanti, quindi potrebbero risultare difficili da rappresentare graficamente in futuro, per ovviare a questo problema si è pensato di rappresentare i dati come tasso di laureati per regione ogni mille abitanti, i valori sono stati poi arrotondati alle sole prime tre cifre decimalI, il dataset dopo la trasformazione si presenta nel seguente modo:
...
showBar
```
essa prende in input una delle colonne del data frame dsTassi, i nomi delle regioni per definire le label della legenda, il titolo da dare al grafico e il numero di righe del dataframe, i colori delle barre sono stati definiti grazie alla funzione **distinctColorPalette** della libreria **randomcoloR**.
...
metodiGerarchici(dsTassi[1:2], regioni, 2, "single", "Metodo del legame singolo")
cls <- applyClustering(dsTassi[1:2], "euclidean", "single", 2)
...
metodiGerarchici(dsTassi[1:2], regioni, 3, "single", "Metodo del legame singolo")
cls <- applyClustering(dsTassi[1:2], "euclidean", "single", 3)
paste("Rapporto tra omogeneità cluster e omogenetà totale, B/T= ", round(cls$bt*100, digits = 2), "%", sep="")
...
metodiGerarchici(dsTassi[1:2], regioni, 2, "complete", "Metodo del legame completo")
cls <- applyClustering(dsTassi[1:2], "euclidean", "complete", 2)
paste("Rapporto tra omogeneità cluster e omogenetà totale, B/T= ", round(cls$bt*100, digits = 2), "%", sep="")
cluster2Table$B.T[3] <- paste(round(cls$bt*100, digits = 2), "%", sep="")

#metodo del legame completo 3 cluster
metodiGerarchici(dsTassi[1:2], regioni, 3, "complete", "Metodo del legame completo")
cls <- applyClustering(dsTassi[1:2], "euclidean", "complete", 3)
paste("Rapporto tra omogeneità cluster e omogenetà totale, B/T= ", round(cls$bt*100, digits = 2), "%", sep="")
...
metodiGerarchici(scale(dsTassi[1:2]), regioni, 2, "average", "Metodo del legame medio")
cls <- applyClustering(dsTassi[1:2], "euclidean", "average", 2)
paste("Rapporto tra omogeneità cluster e omogenetà totale, B/T= ", round(cls$bt*100, digits = 2), "%", sep="")
cluster2Table$B.T[4] <- paste(round(cls$bt*100, digits = 2), "%", sep="")

#metodo del legame medio 3 cluster
metodiGerarchici(scale(dsTassi[1:2]), regioni, 3, "average", "Metodo del legame medio")
cls <- applyClustering(dsTassi[1:2], "euclidean", "average", 3)
paste("Rapporto tra omogeneità cluster e omogenetà totale, B/T= ", round(cls$bt*100, digits = 2), "%", sep="")
...
metodiGerarchici(scale(dsTassi[1:2]), regioni, 2, "centroid", "Metodo del centroide")
cls <- applyClustering(dsTassi[1:2], "euclidean", "centroid", 2)
paste("Rapporto tra omogeneità cluster e omogenetà totale, B/T= ", round(cls$bt*100, digits = 2), "%", sep="")
cluster2Table$B.T[5] <- paste(round(cls$bt*100, digits = 2), "%", sep="")

#metodo del centroide 3 cluster
metodiGerarchici(scale(dsTassi[1:2]), regioni, 3, "centroid", "Metodo del centroide")
cls <- applyClustering(dsTassi[1:2], "euclidean", "centroid", 3)
paste("Rapporto tra omogeneità cluster e omogenetà totale, B/T= ", round(cls$bt*100, digits = 2), "%", sep="")
...
```{r echo=FALSE}
#metodo del centroide 2 cluster
metodiGerarchici(scale(dsTassi[1:2]), regioni, 2, "median", "Metodo della mediana")
cls <- applyClustering(dsTassi[1:2], "euclidean", "median", 2)
paste("Rapporto tra omogeneità cluster e omogenetà totale, B/T= ", round(cls$bt*100, digits = 2), "%", sep="")
cluster2Table$B.T[6] <- paste(round(cls$bt*100, digits = 2), "%", sep="")

#metodo del centroide 3 cluster
metodiGerarchici(scale(dsTassi[1:2]), regioni, 3, "median", "Metodo del centroide")
cls <- applyClustering(dsTassi[1:2], "euclidean", "median", 3)
paste("Rapporto tra omogeneità cluster e omogenetà totale, B/T= ", round(cls$bt*100, digits = 2), "%", sep="")
...
* La misura di non omogeneità **peggiore** si ottiene con i metodi gerarchici del legame singolo, medio, centroide e mediana su 2 cluster(28.24%)
* La misura di non omogeneità **migliore** si ottiene con il metodo k-means su 3 cluster 73.1%
* Altre misure di non omogeneità accettabili sono quelle con un valore superiore al 70% esse sono quelle ottenute con il metodo k-means su 3 cluster e con il metodo gerarchico del legame completo con 3 cluster
